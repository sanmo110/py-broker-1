...
futures_history_data = ef.futures.get_quote_history('8.150130', klt=5)
futures_history_data.to_csv('IM1000-5.csv', index=False)

futures_history_data = ef.futures.get_quote_history('8.150130', klt=15)
futures_history_data.to_csv('IM1000-15.csv', index=False)

futures_history_data = ef.futures.get_quote_history('8.150130', klt=30)
futures_history_data.to_csv('IM1000-30.csv', index=False)

futures_history_data = ef.futures.get_quote_history('8.150130',klt=60)
futures_history_data.to_csv('IM1000-60.csv',index=False)
